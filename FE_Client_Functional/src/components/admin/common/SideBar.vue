...
<template>
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="../dashboard/index.html" class="b-brand text-primary d-flex">
                    <!-- ========   Change your logo from here   ============ -->
                    <img src="@/assets/admin/images/app-icon.png" style="height: 60px;" class="img-fluid logo-lg" alt="logo">
                    <div>Dashboard</div>
                </a>
            </div>
